...
typedef int (*ANeuroEara_getAverageExecutionTime_fn)(ANeuroEara *eara,
...
inline int ANeuroEara_getAverageExecutionTime(ANeuroEara *eara,
                                              vector<vector<uint64_t>> &averageExecTime) {
    LOAD_NN_EARA_FUNCTION(ANeuroEara_getAverageExecutionTime);
    EXECUTE_NN_EARA_FUNCTION(eara, averageExecTime);
}
